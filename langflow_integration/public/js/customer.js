...
function open_ai_chat(frm) {
    ...
    // Welcome message
    append_chat_message('ai', `مرحباً! أنا مساعد AI للعملاء. كيف يمكنني مساعدتك بخصوص العميل ${frm.doc.customer_name}؟`);
}
...
function send_chat_message(frm, session_id) {
    ...
    let context_message = `العميل: ${frm.doc.customer_name}\nالسؤال: ${message}`;
